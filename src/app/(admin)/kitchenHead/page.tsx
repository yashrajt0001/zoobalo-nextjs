            ...
            <>
              ...
              <div className="pr-[3%]">
                <div className="pb-8 px-8">
                  <div className="flex mt-6 text-2xl font-semibold px-2 mb-2">
                    <h1 className="w-[46%] text-center">Name</h1>
                    <h1 className="w-[46%] text-center">Phone</h1>
                  </div>

                  {agents.map((agent: any) => (
                    <div className="bg-white border-b-2 border-gray-200 flex text-2xl py-3 px-2">
                      <h1 className="text-2xl w-[46%] text-center">
                        {agent.name}
                      </h1>
                      <h1 className="text-2xl w-[46%] text-center">
                        {agent.phone}
                          ...
                          <PopoverClose className="flex flex-col w-full items-center">
                            <Button
                              onClick={() => {
                                ...
                                setDeliveryAgentPartnerCode(agent.partnerCode);
                                onOpen("updateAgent");
                              }}
