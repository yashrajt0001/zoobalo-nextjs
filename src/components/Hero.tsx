...
export const Hero = () => {
  return (
    ...
    <div className='flex justify-between'>
      <div className='flex'>
          <Image src={logo} alt="logo" className='w-40 h-44 sm:w-40 sm:h-40 ml-5 -mt-8' />
      ...
      {/* Main Hero Section  */}
        ...
        <div className='sm:w-[45%] ml-14'>
          <h1 className='text-orange-600 text-6xl'>Delicacies Delivered to You: <span className='text-green-600'>Your Daily Tiffin Solution</span></h1>
            <p className='hidden sm:block mt-4'>Explore our tempting thali menus, order effortlessly via WhatsApp, enjoy speedy delivery, and savor exclusive specials.</p>
        ...
        <div className='mt-24 sm:mt-0'>
          <Image src={tiffin} alt="tiffin" className='mx-auto w-96 h-96 sm:mr-24 sm:mt-[-25%]' />
        </div>
      </div>
      </div>
    </>
